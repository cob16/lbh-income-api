module Hackney
  module ServiceCharge
    class Letter
      ...
      attr_reader :tenancy_ref, :correspondence_address_1, :correspondence_address_2,
                  :correspondence_address_3, :correspondence_postcode, :property_address,
      ...
      def initialize(params)
        ...
        @correspondence_address_1 = validated_params[:correspondence_address_1]
        @correspondence_address_2 = validated_params[:correspondence_address_2]
        @correspondence_address_3 = validated_params[:correspondence_address_3]
